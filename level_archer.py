...
def baslat():
    ...
    pygame.display.set_caption("RPG Project Demo")
    ...
    # load images
    # background Images
    background_img = pygame.image.load("magic_forest_bg.png")
    # panel images
    ...
    # sword image
    sword_img = pygame.image.load("../Wizards_And_Warriors/sword.png")
    ...
    class Figther():
        ...
        def attack(self, target):
            ...
            # self variables to attack animation
            self.action = 1
            self.frame_index = 0
            self.update_time = pygame.time.get_ticks()

        def hurt(self):
            # self variables to hurt animation
            self.action = 2
            self.frame_index = 0
            self.update_time = pygame.time.get_ticks()

        def death(self):
            # self variables to death animation
            self.action = 3
            self.frame_index = 0
            self.update_time = pygame.time.get_ticks()
    ...
    knight = Figther(200, 260, 'Knight', 30, 10, 3)
    bandit1 = Figther(550, 270, 'Bandit', 20, 6, 1)
    bandit2 = Figther(700, 270, 'Bandit', 20, 6, 1)
                    ...
                    if bandit.alive == True:
                        ...
                        if action_cooldown >= action_wait_time:
                            ...
                            if (bandit.hp / bandit.max_hp) < 0.5 and bandit.potions > 0:
                                # check if the potions would heal the bandits beyond max health
